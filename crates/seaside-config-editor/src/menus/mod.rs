        ...
        Dialog::new()
            ...
            .button("Done", move |s| {
                let version = *s
                    ...
                    .unwrap();
                s.with_user_data(|user_data: &mut EditableConfig| {
...
pub fn memory_map(_siv: &mut Cursive) {}
