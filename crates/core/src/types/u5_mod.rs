...
impl AddAssign for u5 {
    fn add_assign(&mut self, rhs: Self) {
        *self = self.add(rhs);
    }
}

impl AddAssign<&Self> for u5 {
    fn add_assign(&mut self, rhs: &Self) {
        self.add_assign(*rhs);
    }
}
...
impl BitOrAssign for u5 {
    fn bitor_assign(&mut self, rhs: Self) {
        *self = self.bitor(rhs);
    }
}

impl BitOrAssign<&Self> for u5 {
    fn bitor_assign(&mut self, rhs: &Self) {
...
impl BitXorAssign for u5 {
    fn bitxor_assign(&mut self, rhs: Self) {
        *self = self.bitxor(rhs);
    }
}

impl BitXorAssign<&Self> for u5 {
    fn bitxor_assign(&mut self, rhs: &Self) {
...
impl DivAssign for u5 {
    fn div_assign(&mut self, rhs: Self) {
        *self = self.div(rhs);
    }
}

impl DivAssign<&Self> for u5 {
    fn div_assign(&mut self, rhs: &Self) {
        self.div_assign(*rhs);
    }
}
...
impl MulAssign for u5 {
    fn mul_assign(&mut self, rhs: Self) {
        *self = self.mul(rhs);
    }
}

impl MulAssign<&Self> for u5 {
    fn mul_assign(&mut self, rhs: &Self) {
        self.mul_assign(*rhs);
    }
}
...
impl RemAssign for u5 {
    fn rem_assign(&mut self, rhs: Self) {
        *self = self.rem(rhs);
    }
}

impl RemAssign<&Self> for u5 {
    fn rem_assign(&mut self, rhs: &Self) {
        self.rem_assign(*rhs);
    }
}
...
impl ShlAssign for u5 {
    fn shl_assign(&mut self, rhs: Self) {
        *self = self.shl(rhs);
    }
}

impl ShlAssign<&Self> for u5 {
    fn shl_assign(&mut self, rhs: &Self) {
        self.shl_assign(*rhs);
    }
}
...
impl ShrAssign for u5 {
    fn shr_assign(&mut self, rhs: Self) {
        *self = self.shr(rhs);
    }
}

impl ShrAssign<&Self> for u5 {
    fn shr_assign(&mut self, rhs: &Self) {
        self.shr_assign(*rhs);
    }
}
...
impl SubAssign for u5 {
    fn sub_assign(&mut self, rhs: Self) {
        *self = self.sub(rhs);
    }
}

impl SubAssign<&Self> for u5 {
    fn sub_assign(&mut self, rhs: &Self) {
        self.sub_assign(*rhs);
    }
}
